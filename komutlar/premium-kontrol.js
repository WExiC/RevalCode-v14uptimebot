...
module.exports = {
    ...
    .setDescription('AloneDark Uptime | Premium Üye Olup, Olmadığınızı Söyler')
    ...
    async execute(client, interaction) {   
      ...
      const PremiumAktif = new EmbedBuilder()
         ...
         .setDescription(` **Premium üyeliğiniz bulunmaktadır. Premiumun bitişine kalan zaman:** ${moment.duration(db.fetch(`Premium_${interaction.user.id}`).Bitiş - Date.now()).format('w [hafta] d [gün] h [saat] m [dakika] s [saniye]')}`)
